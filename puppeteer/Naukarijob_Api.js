...
const get_jobs = async (data) => {
  try {
    ...
    const headers = {
      ...
      referer:
        "https://www.naukri.com/front-end-backend-development-jobs?k=front%20end%2C%20backend%20development",
      "user-agent":
      ...
      // Remove 'Accept-Encoding' from headers to let axios handle it automatically
    };
